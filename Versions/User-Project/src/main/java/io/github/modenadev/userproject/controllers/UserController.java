...
//    }
    ...
    @Operation(description = "Change a user",
    ...
    public ResponseEntity<Void> updateUser(
        ...
        userServices.update(id, userRequestDTO);
        return ResponseEntity.noContent().build();
    }


    @Operation(description = "Change a user", summary = "Update a user")
    @PatchMapping("/{id}")
    public ResponseEntity<Void> updateUserPassword(
        ...
        service.updatePassword(id, userRequestDTO.getOldPassword(), userRequestDTO.getPassword());
        return ResponseEntity.noContent().build();
    }
...
//            }
//    )
//    public UserVO updatePassword(@PathVariable(value = "id") Long id) {
