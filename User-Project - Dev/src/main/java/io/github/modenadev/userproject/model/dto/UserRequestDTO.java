...
public class UserRequestDTO {
    ...
    public @NotBlank(message = "Cep is required") @Size(min = 8, max = 12, message = "Cep must be at least 8 characters") Long getCep() {
        return cep;
    }

    public void setCep(@NotBlank(message = "Cep is required") @Size(min = 8, max = 12, message = "Cep must be at least 8 characters") Long cep) {
        this.cep = cep;
    }
